...
% lambda_1_range = [20, 20 ,  1, ];
% lambda_2_range = [3e4, 1,   1,  ];

lambda_1_range = [30, 30 ,  30, 10, 10,];
lambda_2_range = [1e4, 2e3,  1, 2e3,  1, ];
% 
% lambda_1_range = [35, 35 ,  35, 10, 10,];
% lambda_2_range = [7e3, 3e3,  1e2, 5e3,  3e3, ];

% lambda_1_range = [35, 35 ,  30, 10, 10,];
% lambda_2_range = [10, 1,  1, 2e3,  1, ];
lambda_1_range = [2, 2];
lambda_2_range = [1, 1];
% lambda_1_range = [20, 2];
% lambda_2_range = [1, 1];
...
if(IDNI == 1)
    ...
    %         Total_time=8;  %10 ms
        ...
        ekf.StateCovariance = Q ; %% Initial covariance 
        ...
        % %     if((V(i)> interval) || V(i)<0)  %% Negative current
            ...
            V(i+1) = V_measurement; %% voltage measured

            n(i+1) = x_kplus1_corrected(2); %% rest of states are estimated
